...
| Storage staging | Migration `20260923000001_larger_photo_sources.sql` changes only existing private staging file_size_limit to 20,971,520. MIME allowlist, grants, policies and three-hour staging cleanup unchanged. Source/final/round bucket and lossless-output bounds remain 50 MiB. | Migration prepared, not applied. Shared Storage acceptance and hosted end-to-end flows remain unverified until founder-authorized application. |
